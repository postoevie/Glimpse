...
public struct GLICustomFoldersClient: Sendable {
    ...
    public var create: @Sendable (String) async throws -> GLICustomFolder
    ...
    public init(
        ...
        create: @escaping @Sendable (String) async throws -> GLICustomFolder,
...
extension GLICustomFoldersClient {
    ...
    public static func live(
        ...
        GLICustomFoldersClient(
            ...
            create: { name in try await actor.createCustomFolder(name: name) },
